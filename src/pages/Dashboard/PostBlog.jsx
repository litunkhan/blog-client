...
const PostBlog = () => {
  const handlePost = (e)=>{
       ...
       const blog = {author,title,discribtion}
       console.log(blog)
       axios.post('http://localhost:5000/blogpost',blog)
        .then(res=>{
    ...
    return (
        ...
        <form onSubmit={(e)=>handlePost(e)} className="space-y-4 md:space-y-6" >
                        <div>
                            <label htmlFor="author" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Author Name</label>
                            <input type="text" name="user" id="author" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Name" />
                        </div>
                        <div>
                        ...
                        <div>
                            <label htmlFor="discripstion" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Blog discription</label>
                            <textarea className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " name="discription" id="discripstion" cols="30" rows="5" required></textarea>
                        </div>
